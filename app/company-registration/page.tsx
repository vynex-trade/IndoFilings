  ...
  const services = [
    {
      ...
      description:
        "Register your Private Limited Company hassle-free with us. Click here to learn more.",
    ...
    },
    {
      ...
      description:
        "Register your LLP with us easily and enjoy countless benefits. Explore to learn more.",
      icon: <FiUsers size={32} className="text-red-500" />,
      iconBg: "bg-red-50",
      link: "/company-registration/llp-registration",
    },
    {
      id: 3,
      ...
      >
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-slate-200 text-sm md:text-base leading-relaxed max-w-4xl mx-auto">
            Explore Online Legal India to seamlessly register your business with
            expert guidance. From startups to established enterprises, we ensure
            hassle-free company registration with full legal compliance. Get
            your business registered today!
          </p>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((service) => (
            <Link
              key={service.id}
              href={service.link}
              className="group bg-white rounded-xl border border-gray-100 p-6 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300 flex flex-col h-full"
            >
              <div
                className={`w-14 h-14 rounded-lg flex items-center justify-center mb-6 ${service.iconBg}`}
              >
                {service.icon}
              </div>
              ...
              <div className="inline-flex items-center text-orange-500 font-semibold text-sm mt-auto">
                Apply Now
